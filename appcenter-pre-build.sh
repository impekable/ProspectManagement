...
if [ "${ENVIRONMENT}" == "DEV" ]; then
    ...
    echo "Changing REST endpoint to mobilitye1py.khov.com/PY910"
    sed -i '' "s#REST_ENDPOINT#mobilitye1py.khov.com/PY910#g" $KEYPATH/ProspectManagement/Constants/ConnectionURIs.cs
    ...
    echo "Changing REST endpoint to mobilitye1tr.khov.com/TR910"
    sed -i '' "s#REST_ENDPOINT#mobilitye1tr.khov.com/TR910#g" $KEYPATH/ProspectManagement/Constants/ConnectionURIs.cs
    ...
    echo "Changing REST endpoint to mobilitye1pd.khov.com/PD910"
    sed -i '' "s#REST_ENDPOINT#mobilitye1pd.khov.com/PD910#g" ../ProspectManagement/Constants/ConnectionURIs.cs

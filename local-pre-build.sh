...
if [ "$1" == "LOCALDEV" ]; then
    ...
    sed -i '' "s#REST_ENDPOINT#mobilitye1py.khov.com/PY910#g" ../ProspectManagement/Constants/ConnectionURIs.cs
    ...
    sed -i '' "s#REST_ENDPOINT#mobilitye1tr.khov.com/TR910#g" ../ProspectManagement/Constants/ConnectionURIs.cs

...
namespace ProspectManagement.iOS.Views
{
    ...
    public partial class SMSInboxDetailView : MvxViewController<SMSInboxDetailViewModel>, IUITextViewDelegate
    {
        ...
        public SMSInboxDetailView(IntPtr handle) : base(handle)
        {
        }
        ...
        private void setTableViewSource(MvxFluentBindingDescriptionSet<SMSInboxDetailView, SMSInboxDetailViewModel> set)
        {
            ViewModel.Page = 0;
        ...
        private void setNavigationTitle()
        {
            ...
            titleLabel.Text = ViewModel.SmsActivity.Prospect.FirstName + " " + ViewModel.SmsActivity.Prospect.LastName;
            ...
            taskLabel.Text = ViewModel.SmsActivity.Prospect.MobilePhoneNumber?.Phone;
